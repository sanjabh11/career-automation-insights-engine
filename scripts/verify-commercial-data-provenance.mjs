...
const artifacts = [
  ...
  },
  {
    ...
    expectedSnippets: ['getResumeProofReportHtml', 'data-resume-proof-report="true"', 'data-resume-proof-report-redacted', 'data-resume-proof-artifact-boundary="true"', 'Resume Work Transition Proof Report', 'Download Proof Report', 'Save Redacted Artifact', 'Copy Rewrite Drafts', 'coaching draft only', 'Not a hiring, firing, promotion, compensation, layoff, screening, or eligibility decision tool'],
    caveat: 'Resume proof report download is a client-side coaching artifact; saved resume proof artifacts are redacted and user-owned. Production PDF/DOCX parsing, live deployment, external provider retention controls, and employment-decision validation remain separate work.',
  },
  {
