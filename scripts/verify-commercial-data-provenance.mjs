...
const artifacts = [
  ...
  },
  {
    ...
    sourceIds: ['nace-career-readiness', 'dol-ai-literacy-framework', 'nist-ai-rmf', 'ada-ai-hiring-guidance', 'wcag-22', 'lightcast', 'workera-positioning', 'serpapi', 'llm-output'],
    expectedSnippets: ['data-proof-pack-gallery="phase-6-outreach"', 'CRM import pack', 'buildOutreachCsv', 'outreachEvidenceCards', 'source_ids', 'does_not_prove', 'NACE career readiness', 'DOL AI literacy framework', 'Lightcast positioning', 'Workera positioning'],
