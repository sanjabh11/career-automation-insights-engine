...
const artifacts = [
  ...
  {
    id: 'commercial-launch-gate-module',
    label: 'Commercial outreach launch gate model',
    path: 'src/lib/commercialLaunchGate.ts',
    type: 'commercial-governance',
    sourceIds: ['nist-ai-rmf', 'supabase-edge-functions', 'wcag-22', 'llm-output'],
    expectedSnippets: ['commercialLaunchGateItems', 'functionSecurityReviewGroups', 'Auth live E2E secrets', 'Exposed token rotation', 'Public/no-JWT function review', 'Legacy function sprawl', 'Outreach automation', 'Payment fulfillment'],
    caveat: 'Launch-gate model separates controls already implemented from owner-held secrets, manual function review, provider integration, and payment replay evidence still needed before scaled outreach.',
  },
  {
  ...
  },
  {
    ...
    type: 'commercial-verifier',
    sourceIds: ['nist-ai-rmf', 'iso-42001', 'llm-output'],
    expectedSnippets: ['phaseDeliverables', 'confidenceDelta', 'remainingExternalGates', 'Keep the active goal open', 'remediation-completion-audit-latest.md', 'resolveComparisonBase', 'comparisonBaseStatus', 'No known remediation baseline ref is available locally'],
  ...
  {
    id: 'resume-upload-section-ui',
    label: 'Resume upload and server-parser boundary UI',
    path: 'src/components/resume-panels/UploadSection.tsx',
    type: 'commercial-page',
    sourceIds: ['owasp-file-upload', 'supabase-edge-functions', 'nist-ai-rmf', 'wcag-22', 'llm-output'],
    expectedSnippets: ['data-resume-server-parser-receipt="true"', 'data-resume-server-parser-evidence-id', 'serverParserReceipt', 'Upload resume file', 'PDF/DOC/DOCX may require paste fallback', 'Raw file stored:', 'Does not prove:', 'REPORT_TRUST_NOTICES'],
    caveat: 'Upload UI exposes the server-parser receipt and conservative PDF/DOCX fallback boundary; it does not prove parser deployment, malware scanning, external retention deletion, or production extraction quality.',
  },
  {
    id: 'resume-proof-artifact-ui',
    label: 'Resume redacted proof-artifact controls',
    path: 'src/components/resume-panels/RiskScoreCard.tsx',
    type: 'commercial-page',
    sourceIds: ['nist-ai-rmf', 'ada-ai-hiring-guidance', 'eeoc-employment-selection-procedures', 'cfpb-employment-algorithmic-scores', 'wcag-22', 'llm-output'],
    expectedSnippets: ['data-resume-proof-artifact-boundary="true"', 'Save Redacted Artifact', 'savedProofArtifact', 'deleteSavedProofArtifact', 'data-resume-proof-artifact-status', 'data-resume-proof-artifact-deletion-receipt', 'raw resume text, phrase detail rows, and rewrite detail rows are omitted', 'isSupabaseConfigured'],
    caveat: 'The score-card controls expose authenticated redacted-artifact save/delete affordances and receipts; they do not prove live Supabase schema state or external-provider deletion.',
  },
  {
  ...
  },
  {
    ...
    expectedSnippets: ['data-proof-pack-gallery="phase-6-outreach"', 'career-center-cohort-report', 'Institutional readiness packet', 'Trust HTML', 'Risk CSV', 'Local market snapshot pack', 'Snapshot HTML', 'Snapshot CSV', 'data-local-market-snapshot-gallery="true"', 'CRM import pack', 'buildOutreachCsv', 'outreachEvidenceCards', 'data-commercial-launch-gate="true"', 'functionSecurityReviewGroups', 'Secrets stay owner-action only', 'source_ids', 'does_not_prove', 'NACE career readiness', 'NACE first-destination standards', 'FERPA student privacy', 'DOL AI literacy framework', 'Lightcast positioning', 'Workera positioning'],
  ...
  {
    id: 'phase-c-runtime-smoke-ci-workflow-installed',
    label: 'Phase C runtime smoke CI workflow installed',
  ...
  },
  {
    ...
    type: 'live-verifier',
    sourceIds: ['nist-ai-rmf', 'ada-ai-hiring-guidance', 'iso-42001', 'llm-output'],
    expectedSnippets: ['resume_analysis_deletion_receipts', 'delete_resume_analysis_with_receipt', 'resume_proof_report_artifacts', 'create_resume_proof_report_artifact', 'delete_resume_proof_report_artifact_with_receipt', 'log_commercial_report_artifact_event', 'update_commercial_lead_outreach_plan', 'non-mutating-public-api-boundary', 'missing-object-or-schema-cache', 'allow-missing-env'],
