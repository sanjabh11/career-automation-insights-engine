...
const artifacts = [
  ...
  },
  {
    ...
    sourceIds: ['onet', 'onet-task-statements', 'onet-task-ratings', 'onet-task-categories', 'onet-scales-reference', 'bls-emp', 'bls-oews', 'wef-foj-2025', 'oecd-skills-outlook-2025', 'ai-workforce-consortium-2025', 'anthropic-economic-index', 'anthropic-observed-exposure', 'openai-gdpval', 'bls-ai-mlr-2025', 'wcag-22', 'nist-ai-rmf', 'ada-ai-hiring-guidance', 'iso-42001', 'esco', 'lightcast', 'serpapi', 'llm-output'],
