...
const artifacts = [
  ...
  },
  {
    ...
    sourceIds: ['onet', 'bls-emp', 'bls-oews', 'wef-foj-2025', 'oecd-skills-outlook-2025', 'ai-workforce-consortium-2025', 'anthropic-economic-index', 'anthropic-observed-exposure', 'openai-gdpval', 'bls-ai-mlr-2025', 'wcag-22', 'nist-ai-rmf', 'ada-ai-hiring-guidance', 'esco', 'lightcast', 'serpapi', 'llm-output'],
