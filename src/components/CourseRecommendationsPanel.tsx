    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="space-y-2">
          <h2 className="text-2xl font-bold text-[var(--text-primary)]">Course Recommendations</h2>
          <p className="text-[var(--text-secondary)]">Discover courses tailored to your skill development goals</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={selectedLevel} onValueChange={setSelectedLevel}>
                <SelectTrigger className="bg-[var(--bg-secondary)]">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-[var(--text-secondary)]">Provider</label>
      ...
      {isLoading && (
        <Card className="p-12 text-center">
          <div className="space-y-4">
            <Loader2 className="w-16 h-16 animate-spin text-[var(--accent-primary)] mx-auto" />
            <div className="space-y-2">
              <h3 className="text-xl font-semibold text-[var(--text-primary)]">Searching for Courses...</h3>
              <p className="text-[var(--text-secondary)]">Finding the best learning resources for your skills</p>
            </div>
          </div>
        </Card>
      )}
              ...
              <Card className="h-full hover:shadow-lg transition-all duration-200 group">
                <CardHeader className="pb-3">
                  <div className="space-y-2">
                    ...
                    <CardTitle className="text-lg line-clamp-2 group-hover:text-[var(--accent-primary)] transition-colors">
                      {course.title}
                    </CardTitle>
                  </div>
                </CardHeader>
                ...
                <CardContent className="space-y-4 flex-1 flex flex-col">
                  <div className="space-y-3 flex-1">
                    ...
                    {course.description && (
                      <p className="text-sm text-[var(--text-secondary)] line-clamp-3">{course.description}</p>
                    )}
                    
                    <div className="space-y-2">
                      <p className="text-sm font-medium text-[var(--text-secondary)]">Skills you'll learn:</p>
                  ...
                  <Button 
                    className="w-full mt-4 group-hover:bg-[var(--accent-primary)] group-hover:text-[var(--bg-primary)] transition-colors"
                    variant="outline"
        ...
        <Card className="bg-[var(--accent-primary)]/10 border-[var(--accent-primary)]/20">
          <CardContent className="p-6">
            <div className="text-center space-y-2">
              <h3 className="font-semibold text-[var(--text-primary)]">How are these recommendations?</h3>
