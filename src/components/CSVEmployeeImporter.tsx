                ...
                {!uploadSuccess ? (
                    <div className="space-y-4">
                            ...
                            {!file ? (
                                ...
                                <div className="flex items-center justify-between p-3 border rounded-md bg-slate-50">
                                    <div className="flex items-center gap-3">
                                        <div className="bg-[var(--accent-primary)]/20 p-2 rounded-full">
                        ...
                        {file && previewData.length > 0 && (
                            <div className="border rounded-md p-4 bg-slate-50">
                                ...
                                <div className="rounded-md border bg-[var(--bg-secondary)] overflow-hidden">
                                    <Table>
                                        <TableHeader>
                                            <TableRow>
                    ...
                    <Alert className="bg-green-50 border-green-200">
                        ...
                        <AlertDescription className="text-green-700">
                            ...
                            <div className="mt-4">
                                <Button variant="outline" size="sm" onClick={() => setUploadSuccess(false)} className="bg-[var(--bg-secondary)] border-green-200 text-green-700 hover:bg-green-50">
                                    Import Another File
                                </Button>
                            </div>
                        </AlertDescription>
