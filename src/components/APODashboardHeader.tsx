...
export function APODashboardHeader({ selectedJobsCount, onExport }: APODashboardHeaderProps) {
  return (
    <header className="bg-[var(--bg-secondary)] shadow-sm border-b">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-3">
            <div className="bg-[var(--accent-primary)] rounded-lg p-2">
              <BarChart3 className="h-6 w-6 text-white" />
            </div>
            <h1 className="text-2xl font-bold text-[var(--text-primary)]">Occupation Explorer</h1>
