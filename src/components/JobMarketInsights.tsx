  ...
  if (!data) {
    return (
      <Card className="p-6">
        ...
        <p className="text-[var(--text-secondary)]">Job market data temporarily unavailable.</p>
      </Card>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm text-[var(--text-secondary)]">Current Demand</p>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm text-[var(--text-secondary)]">Salary Range</p>
        ...
        <div className="space-y-4">
          <div>
            <p className="text-sm text-[var(--text-secondary)] mb-2">Growth Outlook</p>
          ...
          <div>
            <p className="text-sm text-[var(--text-secondary)] mb-2">Top Locations</p>
              ...
              <div key={index} className="border-l-2 border-blue-200 pl-3 py-2">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-xs text-[var(--text-tertiary)]">{job.location}</p>
                  </div>
                  <div className="text-right">
                    {job.salary && (
                      <p className="text-xs font-medium text-green-600">{job.salary}</p>
                    )}
                    <p className="text-xs text-[var(--text-tertiary)]">{job.posted_date}</p>
                  </div>
                </div>
              </div>
            ))}
