  ...
  return (
    <Card className="p-6">
      <div className="flex items-center space-x-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-[var(--text-primary)]">Top Careers</h3>
      </div>
      
      <div className="space-y-3">
        {topCareers.map((career, index) => (
          <div key={index} className="p-3 border border-[hsl(var(--border))] rounded-lg hover:bg-[var(--bg-hover)] transition-colors">
            <div className="flex items-start justify-between mb-2">
              <h4 className="font-medium text-sm text-[var(--text-primary)]">{career.title}</h4>
