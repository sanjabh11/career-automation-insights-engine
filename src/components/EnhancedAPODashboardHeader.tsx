...
import { CreditBalance } from '@/components/monetization';
...
export function EnhancedAPODashboardHeader({ userEmail, onCreditsClick }: EnhancedAPODashboardHeaderProps) {
      ...
      {isMobileMenuOpen && (
        ...
        >
          <motion.div
            ...
            className="absolute right-0 top-0 h-full w-80 bg-[var(--bg-secondary)] shadow-2xl"
          ...
          >
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="pt-2">
                  <div className="text-xs font-semibold text-[var(--text-tertiary)] mb-1">Dashboard</div>
  ...
  return (
    <>
      <motion.header
        className="sticky top-0 z-40 w-full border-b border-[hsl(var(--border))]/50 bg-[var(--bg-primary)]/80 backdrop-blur-sm shadow-sm"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
            >
              <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-[var(--accent-primary)] to-[var(--accent-secondary)] rounded-xl shadow-lg">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-[var(--text-tertiary)]">Automation Insights</p>
              </div>
            </motion.div>

            {/* Desktop Navigation */}
            <div className="hidden md:flex items-center gap-3">
              <Button variant="ghost" onClick={goCareerPlanning} className="hover:bg-[var(--accent-primary)]/10">Career Planning</Button>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-6">
            <div className="text-center space-y-3">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--accent-primary)]/10 rounded-full">
                <Star className="w-4 h-4 text-[var(--accent-primary)]" />
                <span className="text-sm font-medium text-[var(--text-primary)]">Current Plan: Free Tier</span>
              </div>
            ...
            <Card className="bg-[var(--bg-tertiary)] border-[hsl(var(--border))]">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  <Shield className="w-5 h-5 text-[var(--accent-primary)] mt-0.5" />
                  <div className="space-y-1">
                    <h4 className="text-sm font-medium text-[var(--text-primary)]">Usage Tips</h4>
