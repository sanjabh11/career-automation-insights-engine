      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {displayedOccupations.map((related, index) => (
            ...
            >
              <Card 
                className="p-4 hover:shadow-md transition-all cursor-pointer border-l-4 border-l-[var(--accent-primary)] bg-gradient-to-r from-[var(--bg-primary)] to-[var(--accent-primary)]/5"
