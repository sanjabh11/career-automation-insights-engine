...
<head>
  <meta charset="utf-8"/>
  <title>Automation Defense Estimate: ${data.title} | Automation Insights</title>
  <style>
...
<body>
  <div class="header">
    <h1>Automation Defense Estimate</h1>
  ...
  <div class="bridge">
    ...
    <div>Bridge-role exposure estimate: ${data.bridgeRoleRisk}% &mdash; ${data.bridgeRoleRisk <= 30 ? 'lower review priority' : 'lower exposure estimate'} than ${data.title}</div>
  </div>
  ...
  return (
    <Card className="border-[var(--accent-primary)]/30 bg-[var(--accent-primary)]/5">
      <CardHeader className="text-center pb-3">
        ...
        <CardDescription>
          Get a printable, shareable automation-defense estimate for {data.title}s, with source and review boundaries.
        </CardDescription>
      </CardHeader>
      <CardContent>
