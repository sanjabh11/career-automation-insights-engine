...
export function SystemAdminPanel() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-[var(--text-primary)] mb-2">System Monitoring</h2>
        <p className="text-[var(--text-secondary)]">Monitor system health and rate limits</p>
      </div>
