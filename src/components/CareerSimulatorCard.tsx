  ...
  return (
    <Card className="p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="text-[10px] text-[var(--text-tertiary)]">Monte Carlo-lite</div>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-3">
        <div>
          <label className="text-xs text-[var(--text-secondary)]">Hours/week</label>
        ...
        <div>
          <label className="text-xs text-[var(--text-secondary)]">Max months</label>
      ...
      {result && (
        <div className="mt-4 grid grid-cols-2 md:grid-cols-5 gap-2">
          <div className="p-2 rounded border">
            <div className="text-[10px] text-[var(--text-tertiary)]">P50 timeline</div>
            <div className="text-sm font-semibold">{result.months_p50} mo</div>
          </div>
          <div className="p-2 rounded border">
            <div className="text-[10px] text-[var(--text-tertiary)]">P90 timeline</div>
            <div className="text-sm font-semibold">{result.months_p90} mo</div>
          </div>
          <div className="p-2 rounded border">
            <div className="text-[10px] text-[var(--text-tertiary)]">Success @12m</div>
            <div className="text-sm font-semibold">{Math.round(result.p_success_12m*100)}%</div>
          </div>
          <div className="p-2 rounded border">
            <div className="text-[10px] text-[var(--text-tertiary)]">Success @18m</div>
            <div className="text-sm font-semibold">{Math.round(result.p_success_18m*100)}%</div>
          </div>
          <div className="p-2 rounded border">
            <div className="text-[10px] text-[var(--text-tertiary)]">Success @24m</div>
          ...
          {typeof result.median_salary_at_completion === 'number' && (
            <div className="p-2 rounded border col-span-2">
              <div className="text-[10px] text-[var(--text-tertiary)]">Median salary at completion</div>
