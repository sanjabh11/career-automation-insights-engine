                ...
                <CardContent className="flex-1 overflow-y-auto p-0">
                    <div className="divide-y">
                        {submissions.map((submission) => (
                            <div
                                key={submission.id}
                                className={`p-4 cursor-pointer hover:bg-slate-50 transition-colors ${selectedSubmission?.id === submission.id ? 'bg-[var(--accent-primary)]/10 hover:bg-[var(--accent-primary)]/10' : ''
                                    }`}
