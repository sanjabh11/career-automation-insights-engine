  ...
  if (isLoading) {
    return (
      <Card className="w-full">
        ...
        <CardContent>
          <div className="text-center py-4 text-[var(--text-tertiary)]">Checking system status...</div>
        </CardContent>
      </Card>
    );
  }
    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        {error ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center gap-3 p-3 bg-[var(--bg-tertiary)] rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--text-secondary)]">{healthStatus.database}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-[var(--bg-tertiary)] rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--text-secondary)]">{healthStatus.cache_entries}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-[var(--bg-tertiary)] rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--text-secondary)]">{healthStatus.version}</p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center py-4 text-[var(--text-tertiary)]">No health data available</div>
        )}
      </CardContent>
    </Card>
  );
