          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label className="text-sm font-medium text-[var(--text-tertiary)]">Occupation</Label>
                  <p className="font-medium">{analysis?.occupation_title}</p>
                </div>
                <div>
                  <Label className="text-sm font-medium text-[var(--text-tertiary)]">O*NET Code</Label>
                  <p className="font-medium">{analysis?.occupation_code}</p>
                </div>
                <div>
                  <Label className="text-sm font-medium text-[var(--text-tertiary)]">Analysis Date</Label>
              ...
              {analysis?.notes && (
                <div className="mt-4">
                  <Label className="text-sm font-medium text-[var(--text-tertiary)]">Notes</Label>
                  <p className="text-[var(--text-secondary)] mt-1">{analysis.notes}</p>
                </div>
              )}
            </CardContent>
          </Card>
