    ...
    <div className="container mx-auto max-w-6xl p-4">
      ...
      <div className="overflow-auto border rounded">
        <table className="min-w-full text-sm">
          ...
          <tbody>
            {filtered.map((r, i) => (
              <tr key={i} className={i % 2 ? "bg-[var(--bg-secondary)]" : "bg-[var(--bg-tertiary)]/50"}>
                ...
                <td className="p-2 whitespace-nowrap truncate max-w-[300px]">
                  {r.source_url ? (
                    <a className="text-[var(--accent-primary)] hover:underline" href={r.source_url} target="_blank" rel="noreferrer">{r.source || r.source_url}</a>
                  ) : (r.source || "")}
                </td>
              </tr>
            ))}
