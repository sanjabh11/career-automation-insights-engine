      ...
      <div className="container mx-auto px-4 py-12">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              You are not currently enrolled in any bootcamp cohorts.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground mb-4">
              To access the bootcamp dashboard, you need to be enrolled in an active cohort.
            </p>
            ...
            <CardContent>
              <div className="space-y-4">
                {liveSessions.map((session) => (
                  ...
                  >
                    <div className="w-12 h-12 rounded-lg bg-[var(--accent-primary)]/10 flex items-center justify-center shrink-0">
