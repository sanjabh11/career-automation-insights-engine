...
import { Loader2, Search, TrendingUp, Code2, Zap } from "lucide-react";
      ...
      <Card className="p-4">
        <div className="flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2">
            ...
            <Badge className="bg-[var(--accent-primary)]/20 text-[var(--accent-primary)] border-[var(--accent-primary)]/30">0–39</Badge>
          </div>
          <div className="flex items-center gap-2">
            {source === "db" ? (
                ...
                >
                  <Card
                    className={`p-3 cursor-pointer transition-all ${
                      isSelected
                        ? "bg-[var(--accent-primary)]/10 border-[var(--accent-primary)] border-2 shadow-md"
          ...
          {selectedTech && !occupationsLoading && (
            <div className="space-y-3 max-h-[600px] overflow-y-auto">
              <div className="mb-4 p-3 bg-[var(--accent-primary)]/10 rounded-lg border border-[var(--accent-primary)]/20">
                ...
                {techViewLoading && (
                  <div className="text-xs text-[var(--accent-primary)] mt-1">Loading insights…</div>
                )}
                {techViewData && (
                  <div className="text-xs text-[var(--text-primary)] mt-2">
