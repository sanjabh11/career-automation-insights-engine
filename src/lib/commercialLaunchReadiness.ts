...
export const commercialLaunchReadinessMilestones: CommercialLaunchReadinessMilestone[] = [
  ...
  },
  {
    ...
    pending: "Redeploy latest stripe-webhook, replay Stripe test events, and prove report-credit balance changes.",
    rating: 3.4,
    remainingPercent: 32,
  ...
  },
  {
    ...
    done: "Lead ops, stages, priorities, sequence step, next action, follow-up date, and CSV export exist.",
    pending: "Email/CRM automation, unsubscribe handling, tracked links, and response analytics.",
    rating: 4.0,
    remainingPercent: 20,
  ...
  },
  {
    ...
    done: "Evidence cards, privacy/deletion receipts, AI RMF rows, WCAG smoke, and employment-decision boundaries exist.",
    pending: "Manual WCAG notes, signed buyer acceptable-use review, and formal legal copy.",
    rating: 4.1,
    remainingPercent: 18,
...
export const paymentFulfillmentStatusItems: PaymentFulfillmentStatusItem[] = [
  ...
  },
  {
    ...
    remainingAction: "Redeploy latest checkout source after function-cap cleanup and run a credit purchase test.",
    status: "blocked",
    maturity: 3.3,
  },
  {
    ...
    remainingAction: "Redeploy latest stripe-webhook and replay Stripe test events before claiming live credit fulfillment.",
    status: "blocked",
    maturity: 3.2,
  },
  {
