...
export const SOURCE_REFRESH_MANIFEST: SourceManifestEntry[] = [
  {
    ...
    usedFor: 'SOC occupation metadata, work activities, task context, and skill descriptors.',
    caveat: 'O*NET describes occupations, not individual people or employer-specific job design.',
