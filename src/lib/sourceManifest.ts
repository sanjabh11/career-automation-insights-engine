...
export const SOURCE_REFRESH_MANIFEST: SourceManifestEntry[] = [
  ...
  },
  {
    ...
    label: 'AI Workforce Consortium ICT in Motion 2025',
    provider: 'AI Workforce Consortium led by Cisco',
    currentVersion: 'ICT in Motion: The Next Wave of AI Integration, 2025 report',
    releaseDate: 'Published September 2025',
    lastVerifiedAt: SOURCE_MANIFEST_LAST_VERIFIED_AT,
    integrationStatus: 'active',
    confidence: 'medium',
    refreshCadence: 'Review consortium reports, glossary, and role/skill keywords before refreshing AI-era role radar labels.',
    usedFor: 'Market-signal caveats for emerging AI-era role labels and AI skill demand language.',
    caveat: 'The report focuses on ICT and specialized support roles across G7 countries; it is not a complete taxonomy or proof that an emerging role exists in every labor market.',
    claimBoundary: 'Use as market-signal context only until role labels are validated against live postings and mapped to SOC/O*NET or ESCO.',
