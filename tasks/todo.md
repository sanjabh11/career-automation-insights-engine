...
- `npm run lint` still fails on active type-hardening debt: latest JSON run reports 97 explicit-`any` errors and 34 React warnings after excluding inactive backups/archives.
