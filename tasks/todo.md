...
- `npm run lint` still fails on active type-hardening debt: latest JSON run reports 88 explicit-`any` errors and 33 React warnings after excluding inactive backups/archives.
