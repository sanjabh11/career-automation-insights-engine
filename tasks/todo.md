...
- `npm run lint` still fails on active type-hardening debt: latest JSON run reports 66 explicit-`any` errors and 32 React warnings after excluding inactive backups/archives.
