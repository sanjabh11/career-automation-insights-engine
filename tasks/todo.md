...
- Phase E `npm run lint` remains red on active type-hardening debt; the latest run observes 373 explicit-`any` errors and 34 React warnings after inactive backups/archives and mechanical non-`any` errors were cleared.
