...
- `npm run lint` still fails on active type-hardening debt: latest JSON run reports 36 explicit-`any` errors and 31 React warnings after excluding inactive backups/archives.
