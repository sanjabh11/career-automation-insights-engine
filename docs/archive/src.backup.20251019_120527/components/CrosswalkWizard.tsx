    ...
    <Card className="p-4 md:p-6 space-y-4">
      ...
      <div className="flex flex-wrap gap-2">
        <Button
          ...
          size="sm"
          variant="outline"
          onClick={() => { setFrom("SOC"); setCode("15-1252.00"); setTo("ALL"); setSubmitted({ from: "SOC", code: "15-1252.00" }); }}
        >
          Try SOC 15-1252 (Software Developers)
        </Button>
        <Button
          type="button"
          size="sm"
          variant="outline"
          onClick={() => { setFrom("MOC"); setCode("11B"); setTo("ALL"); setSubmitted({ from: "MOC", code: "11B" }); }}
        >
          Try MOC 11B (Infantry)
        </Button>
        <Button
          type="button"
          size="sm"
          variant="outline"
          onClick={() => { setFrom("CIP"); setCode("11.0701"); setTo("SOC"); setSubmitted({ from: "CIP", code: "11.0701", to: "SOC" }); }}
        >
          Try CIP 11.0701 → SOC
        </Button>
        <Button
          ...
          size="sm"
          variant="outline"
          onClick={() => { setFrom("DOT"); setCode("003.167-010"); setTo("SOC"); setSubmitted({ from: "DOT", code: "003.167-010", to: "SOC" }); }}
        >
          Try DOT 003.167-010 → SOC
        </Button>
      </div>
