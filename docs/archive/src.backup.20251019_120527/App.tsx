...
import TaskMatchPage from "./pages/TaskMatchPage";
import IndustryDashboardPage from "./pages/IndustryDashboardPage";
import AdminParityPage from "./pages/AdminParityPage";
import ProfilerPage from "./pages/ProfilerPage";
import CipEducationPage from "./pages/CipEducationPage";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/task-match" element={<TaskMatchPage />} />
            ...
            <Route path="/admin/parity" element={<AdminParityPage />} />
            <Route path="/profiler" element={<ProfilerPage />} />
            <Route path="/education" element={<CipEducationPage />} />
