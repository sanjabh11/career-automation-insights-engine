...
| PBI-0009 | User | As a user, I want a scalable market heatmap that visualizes occupation exposure and employment signals without slowing down the existing product. | InProgress | 1. Heatmap data layer tables created<br>2. Snapshot/publish workflow defined<br>3. Read API added for heatmap cells<br>4. Isolated route added without regressions to search/planner/detail flows<br>5. Validation and performance checks documented |
