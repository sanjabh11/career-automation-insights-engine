...
| GitHub CI | Installed commercial proof-pack workflow with Node 24-compatible action wrappers and Node 20 app runtime | Hosted push and manual source/audit runs must be checked after each workflow-affecting push |
