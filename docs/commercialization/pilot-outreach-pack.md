...
| 10 | Accessibility gate before outreach | Common requirement, often skipped | High | Medium | Scripted, pending full pass |
...
| 19 | CRM/email automation for leads | Common commercial need | High | High | Pending |
| 20 | Public sample gallery by occupation | Common marketing pattern | Medium | High | Pending |
