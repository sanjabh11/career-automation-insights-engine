...
|---|---|---|---:|---:|---:|---|
| Phase 0: Stabilize branch and CI | Clean GitHub checkout, branch, commercial scripts, build gate, route smoke, commercial index, trust/data provenance checks, branch pushed, verified collaborator write access, and installed `.github/workflows/commercial-proof-pack.yml` with read-only permissions plus Playwright journey/a11y gates. | Hosted GitHub Actions run evidence after workflow push. | 4.5 | 6% | 7% | Yes for bounded pilots after first hosted run is inspected. |
...
2. Push the installed `.github/workflows/commercial-proof-pack.yml` workflow, inspect the first hosted GitHub Actions run, and keep `docs/commercialization/commercial-proof-pack.workflow.yml` as the reference template.
