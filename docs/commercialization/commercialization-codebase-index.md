...
Generated: 2026-05-24T17:45:42.781Z
...
| Institutional readiness and governance packet | Career centers, workforce boards, L&D teams, institutional pilot reviewers | `/proof-pack-gallery` | Downloadable trust packet now includes an institutional risk register, AI RMF Govern/Map/Measure/Manage controls, WCAG 2.2 accessibility gate, employment-decision boundary, live proof blockers, evidence cards, and a CSV risk register for buyer review. | `src/lib/institutionalReadinessPacket.ts`<br/>`src/pages/ProofPackGalleryPage.tsx`<br/>`scripts/verify-report-evidence.mjs`<br/>`scripts/verify-commercial-browser.mjs`<br/>`scripts/verify-commercial-data-provenance.mjs` |
