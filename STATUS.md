...
- `docs/commercialization/commercial-evidence-records-template.json`, `scripts/verify-commercial-evidence-records.mjs`, and `npm run verify:commercial-evidence-records` provide a redacted owner-record schema for committed design partners and documented outcomes. The current artifact is `no_local_evidence`, not partner or outcome proof.
