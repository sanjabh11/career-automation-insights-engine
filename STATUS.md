...
| `npm run verify:commercial-evidence-records` | Pass | Confirmed the redacted commercial evidence records verifier is wired and no local partner/outcome evidence file is currently attached. A passing partner/outcome proof still requires owner-held permissioned records. |
